    ...
    <>
      ...
      <div className="container-fluid col-md-6 offset-md-3">
        <form
          ...
          action="http://localhost:8080/pedidos"
          method="post"
        >
          ...
          <div className="form-group">
            ...
            <input className="form-control" name="endereco" id="endereco" type="text" required />
          </div>
          <div className="form-group">
          ...
          <div className="form-group">
            ...
            <select className="form-control" id="produto" name="produto">
