    ...
    return (
        <>
         ...
         <ul className="list-group ulCat">
                    <li onClick={exibir} className="list-group-item box ">Todos (12)</li>
                    <li onClick={() => exibirTodos('Geladeiras')} className="list-group-item box">Geladeiras (3)</li>
                    <li onClick={() => exibirTodos('Fogões')} className="list-group-item box">Fogões (2)</li>
                    <li onClick={() => exibirTodos('Microondas')} className="list-group-item box">Microondas (3)</li>
                    <li onClick={() => exibirTodos('Lavadouras de Roupa')} className="list-group-item box">Lavadoras de Roupas (2)</li>
                    <li onClick={() => exibirTodos('Lava-louças')} className="list-group-item box">Lava-louças (2)</li>
                </ul>
         */} 
